    ...
    <div class="col-4">
        ...
        <form action="./veiculo.php/?page=salvar" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control d-block p-3" name="VeiculoID" placeholder="Exemplo: 123">
                <label class="form-label mt-2">Nome do veículo</label>
                <input type="text" class="form-control d-block p-3" name="Modelo" placeholder="Exemplo: Civic">
                <label class="form-label mt-2">Marca do veículo</label>
                <input type="text" class="form-control d-block p-3" name="Marca" placeholder="Exemplo: Honda">
                <label class="form-label mt-2">Ano do veículo</label>
                <input type="number" class="form-control d-block p-3" name="Ano" placeholder="Exemplo: 2022">
                <label class="form-label mt-2">Preço</label>
                <input type="number" class="form-control d-block p-3" name="Preco" placeholder="Exemplo: 90.000">
                <label for="Salario" class="form-label mt-2">Estoque</label>
                <input type="number" class="form-control d-block p-3" name="Estoque" placeholder="Exemplo: 60">
