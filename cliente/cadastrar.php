    ...
    <div class="col-4">
        ...
        <form action="./cliente.php/?page=salvar" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control d-block p-3" name="ClienteID" placeholder="Exemplo: 123">

                <label class="form-label mt-2">Nome do Cliente</label>
                <input type="text" class="form-control d-block p-3" name="Nome" placeholder="Exemplo: João Silva">

                <label class="form-label mt-2">CPF do Cliente</label>
                <input type="number" class="form-control d-block p-3" name="CPF" placeholder="Exemplo: 12345678901">

                <label class="form-label mt-2">Telefone do Cliente</label>
                <input type="tel" class="form-control d-block p-3" name="Telefone" placeholder="Exemplo: (11) 98765-4321">

                <label class="form-label mt-2">Email do Cliente</label>
                <input type="email" class="form-control d-block p-3" name="Email" placeholder="Exemplo: joao@email.com">
